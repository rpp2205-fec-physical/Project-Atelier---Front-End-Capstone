  ...
  stars(reviews) {
    if (reviews.ratings.ratings) {
      return (<div>
        ...
        <p className="review" onClick={() => {alert('Our review guy is on vacation but for now just trust us - this product is unbelievable!')}}>Read All {this.state.reviews} Reviews</p>
        </div>);
    } else {
